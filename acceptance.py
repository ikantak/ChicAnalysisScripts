...
def cutacceptance_plot(filename, option, plotname):
    ...
    if option == 7: 
        ...
        # pt_mc_chic12 = TH1D("ptchic12", "ptchic12", 2000, 0, 20 )
        # pt_mc_chic12.Add(pt_mc_chic1, pt_mc_chic2, 1.0, 1.0)
        mc_eephoton_chic1 = list_data2.FindObject("MCTruthGenTriple_cut_eePhotonFromChic1")
        pt_mc_eephoton_chic1 = mc_eephoton_chic1.FindObject("Pt_DileptonPhoton")
        mc_eephoton_chic2 = list_data2.FindObject("MCTruthGenTriple_cut_eePhotonFromChic2")
        pt_mc_eephoton_chic2 = mc_eephoton_chic2.FindObject("Pt_DileptonPhoton")
        ...
        # pt_mc_chic12.Rebin(40)
        # pt_mc_eephoton_chic12.Rebin(40)
        # print(pt_mc_chic12.GetNbinsX())
        # print(pt_mc_eephoton_chic12.GetNbinsX())
        #.GetXaxis().SetRangeUser(0.0, 20.0)
    if option == 8: 
    ...
    if option == 12: 
        ...
        mc_ee_chic2 = list_data2.FindObject("MCTruthGenPair_cut_eeFromJpsiFromChic2")
        pt_mc_ee_chic2 = mc_ee_chic2.FindObject("Pt")
        # pt_mc_chic12 = pt_mc_chic1.Clone("pt chic12")
        # pt_mc_chic12.Add(pt_mc_chic2, 1)
        # pt_mc_ee_chic12 = pt_mc_ee_chic1.Clone("pt eechic12")
        # pt_mc_ee_chic12.Add(pt_mc_ee_chic2, 1)
...
if __name__ == "__main__":
    ...
    #cutacceptance_plot(filename, 7, "20240215/plot_acceptance_eephotonchic12.svg")
    # cutacceptance_plot(filename, 0, "20240225/plot_acceptance_eejpsi.pdf")
    # cutacceptance_plot(filename, 0, "20240225/plot_acceptance_eejpsi.svg")
    cutacceptance_plot(filename, 7, "20240225/plot_acceptance_eephotonchic.pdf")
    cutacceptance_plot(filename, 7, "20240225/plot_acceptance_eephotonchic.svg")
    cutacceptance_plot(filename, 12, "20240225/plot_acceptance_eechic12.pdf")
    cutacceptance_plot(filename, 12, "20240225/plot_acceptance_eechic12.svg")
